...
const { education, diplomado, resumeStatement, skills: skillsObj } = CONTENT;
    ...
    <PageWrapper className="flex flex-col lg:flex-row gap-8 relative">
      <div className="w-full lg:w-2/5 lg:min-h-screen">
        <div className="flex flex-col gap-12 print:gap-4 sticky top-12">
          <Profile />
          <ContentBlock title="Resumen">
            <p>{resumeStatement}</p>
          </ContentBlock>
          <ContentBlock title="Habilidades">
          ...
          <ContentBlock title="Educación">
            <JobExperience {...education} />
          </ContentBlock>
          <ContentBlock title="Diplomado">
            <JobExperience {...diplomado} />
          </ContentBlock>
